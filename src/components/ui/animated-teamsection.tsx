...
import { ArrowLeftCircleIcon, ArrowRightCircleIcon, MoveLeft, MoveRight } from "lucide-react";
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
                ...
                <div className="flex justify-between flex-col py-4">
                    ...
                    <div className="flex justify-center md:justify-start gap-4 pt-12 md:pt-0">
                        ...
                        >
                            <ArrowLeftCircleIcon className="h-8 w-8 bg-gray-300 rounded-full cursor-pointer" />
                        </button>
                        <button
                            onClick={handleNext}
                            className="h-8 w-8 rounded-full bg-secondary flex items-center justify-center group/button"
                        >
                            <ArrowRightCircleIcon className="h-8 w-8 bg-gray-300 rounded-full cursor-pointer" />
                        </button>
                    </div>
                </div>
            </div>
